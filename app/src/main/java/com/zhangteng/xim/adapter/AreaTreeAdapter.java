 ...
 */
public class AreaTreeAdapter<T> extends TreeRecyclerViewAdapter<T> {
    /**
     * @param mTree
     * @param context
     * @param datas
     ...
     */
    public AreaTreeAdapter(RecyclerView mTree, Context context, List<T> datas, int defaultExpandLevel) throws IllegalArgumentException, IllegalAccessException {
